...
from ymda.deep_research.state_research import Summary
from ymda.deep_research.prompts import summarize_webpage_prompt, report_generation_with_draft_insight_prompt
...
def summarize_webpage_content(webpage_content: str) -> str:
    ...
    try:
        ...
        stats.extract_usage_from_response(
            ...
            function_name="summarize_webpage_content"
        )
...
def refine_draft_report(research_brief: Annotated[str, InjectedToolArg], 
    ...
    stats.extract_usage_from_response(
        ...
        function_name="refine_draft_report"
    )
